...
LEFT OUTER JOIN TREXONE_DW_DATA.FACILITY facility
    ...
    --AND facility.FD_FACILITY_KEY NOT IN (530,531,532,533,502,534,535,536,537,51894,539,540,553,554,555,557,558,559,560,561,556,3659902,516015)
...
WHERE RXERP.EFF_START_DATE BETWEEN TRUNC(SYSDATE-1)+17/24 AND TRUNC(SYSDATE)