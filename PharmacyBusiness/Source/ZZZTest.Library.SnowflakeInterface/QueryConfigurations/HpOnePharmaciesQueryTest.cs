...
{
    public class HpOnePharmaciesQueryTest
    {
        /// <summary>
        /// Tests that <see cref="HpOnePharmaciesQuery"/> correctly maps all fields
        /// </summary>
        [Theory]
        [ClassData(typeof(HpOnePharmaciesQueryTest.MappingTests))]
        public void MapFromDataReaderToType_Returns_MappedObject((object[], HpOnePharmaciesRow) testParameters)
        {
            // Arrange
            (object[] readerIndex, HpOnePharmaciesRow expectedResult) = testParameters;
            HpOnePharmaciesQuery query = new HpOnePharmaciesQuery();
            ...
            // Act
            HpOnePharmaciesRow res = query.MapFromDataReaderToType(mockedReader, s => { });
        ...
        public class MappingTests : TheoryData<(object[], HpOnePharmaciesRow)>
        {
            public MappingTests()
            {
                AddRow((
                new object[] {
                    "Npi", "PharmacyName", "AddressLine1", "AddressLine2", "City", "State", "ZipCode", "StorePhoneNumber", "FaxPhoneNumber", "PaidSearchRadius", "Banner"
                },
                new HpOnePharmaciesRow
                {
                    Npi = "Npi",
                    ...
                    PaidSearchRadius = "PaidSearchRadius",
                    Banner = "Banner",
                }
                ));
                ...
                AddRow((
                new object[] {
                   "1528042611", "#001 JOHN GLENN", "7519 OSWEGO RD", "null", "LIVERPOOL", "NY", "13090", "3156222100", "3155461298", "null", "null"
                },
                new HpOnePharmaciesRow
                {
                    Npi = "1528042611",
