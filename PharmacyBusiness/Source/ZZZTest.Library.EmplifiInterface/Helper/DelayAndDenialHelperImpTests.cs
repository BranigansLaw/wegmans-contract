...
{
    public class DelayAndDenialHelperImpTests
    {
        private readonly DelayAndDenialHelperImp _sut;

        public DelayAndDenialHelperImpTests()
        {
            _sut = new DelayAndDenialHelperImp();
        }
        ...
        public void GetDateRangeForOutboundStatus_ShouldThrowExceptionOnWeekends(string runForDateTime, DayOfWeek expectedDayOfWeek)
        {
            ...
            // Assert
            Assert.Equal("Delay and Denial Outbound Status job only runs M-F.", thrown.Message);
        ...
        [Theory]
        [InlineData("06/20/2024 08:29:00", 3, 3)]
