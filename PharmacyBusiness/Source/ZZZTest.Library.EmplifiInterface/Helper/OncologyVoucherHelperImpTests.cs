...
public class OncologyVoucherHelperImpTests
{
    ...
    private readonly OncologyVoucherTriageHelperImp _helper;
    ...
    public OncologyVoucherHelperImpTests()
    {
        _config = Substitute.For<IOptions<EmplifiConfig>>();
        _logger = Substitute.For<ILogger<OncologyVoucherTriageHelperImp>>();
        ...
        _helper = new OncologyVoucherTriageHelperImp(
            _logger,
            _config,
            _mockCaseService,
            _mockAddressService,
    ...
    [InlineData(null)]
    [InlineData("")]
    public void DeriveDate_ShouldReturnNull_WhenInvalidDateStringIsPassed(string? input)
    {
        // Arrange
        ...
        )
    {
        ...
        var ibmOncologyVoucherTriageRow = new IbmOncologyVoucherTriageRow
        {
            ...
            PrescriberAddress1 = "PrescriberAddress1",
            PrescriberAddress2 = "PrescriberAddress2",
            PrescriberCity = "PrescriberCity",
            PrescriberState = "PrescriberState",
            PrescriberZipCode = "PrescriberZipCode",
            PrescriberPhoneNumber = "PrescriberPhoneNumber",
            PrescriberFaxNumber = "PrescriberFaxNumber",
            PatientDemographicId = "PatientDemographicId",
            CarePathTransactionId = "CarePathTransactionId"
        };

        // Act
        var result = _helper.DeriveCaseText(
            ibmOncologyVoucherTriageRow,
            patientDateOfBirth,
            patientGender
        );

        // Assert
        var expected = $"CarePath Patient ID: {ibmOncologyVoucherTriageRow.CarePathPatientId}{Environment.NewLine}" +
    ...
    [Fact]
    public async Task FindAddressesForOncologyVoucherTriageAsync_ShouldReturnAddresses_WhenPatientDemographicIdIsValid()
    {
        // Arrange
        ...
        // Act
        var result = await _helper.FindAddressesForOncologyVoucherTriageAsync(
            carePathPatientId, patientDemographicId, state, dateOfBirth, lastName, firstName);
    ...
    [Fact]
    public async Task FindAddressesForOncologyVoucherTriageAsync_ShouldReturnAddresses_WhenCarePathPatientIdIsValid()
    {
        // Arrange
        var patientDemographicId = "123";
        var carePathPatientId = "456";
    ...
    [Fact]
    public async Task FindAddressesForOncologyVoucherTriageAsync_ShouldReturnAddresses_WhenLastNameFirstNameStateIsValid()
    {
        // Arrange
        var patientDemographicId = "123";
        var carePathPatientId = "456";
    ...
    [Fact]
    public async Task FindAddressesForOncologyVoucherTriageAsync_ShouldReturnEmpty_WhenNoValidAddresses()
    {
        // Arrange
        var patientDemographicId = "123";
        var carePathPatientId = "456";
    ...
    [Fact]
    public async Task CreateAddressFromOncologyVoucherTriageAsync_ShouldReturnAddressId_WhenInputIsValid()
    {
        // Arrange
        var oncologyVoucherTriage = new OncologyVoucherTriage()
        {
            ...
            PrescriberFaxNumber = "098-765-4321",
        ...
        // Act
        var result = await _helper.CreateAddressFromOncologyVoucherTriageAsync(oncologyVoucherTriage, CancellationToken.None);
    ...
    [InlineData(AddressServiceWrapper.ValidState.Error)]
    [InlineData(AddressServiceWrapper.ValidState.Unknown)]
    public async Task CreateAddressFromOncologyVoucherTriageAsync_ShouldThrowException_WhenResponseIsInvalid(AddressServiceWrapper.ValidState validState)
    {
        // Arrange
        var oncologyVoucherTriage = new OncologyVoucherTriage();
        var response = new AddressListResponse
        ...
        // Act & Assert
        await Assert.ThrowsAsync<GeneralApiException>(() => _helper.CreateAddressFromOncologyVoucherTriageAsync(oncologyVoucherTriage, CancellationToken.None));
    }

    [Fact]
    public async Task CreateAddressFromOncologyVoucherTriageAsync_ShouldThrowException_WhenResponseIsNull()
    {
        // Arrange
        var oncologyVoucherTriage = new OncologyVoucherTriage();
    ...
    [Fact]
    public async Task UpdateAddressFromOncologyVoucherTriageAsync_ShouldUpdateAddressSuccessfully()
    {
        // Arrange
        ...
        var oncologyVoucherTriage = new OncologyVoucherTriage
        {
            ...
            PrescriberState = "NY",
            PrescriberZipCode = "12345",
            PrescriberPhoneNumber = "555-1234",
            PrescriberFaxNumber = "555-5678",
            PrescriberNpi = "1234567890",
        ...
        // Act
        await _helper.UpdateAddressFromOncologyVoucherTriageAsync(address, oncologyVoucherTriage, cancellationToken);
    ...
    [Fact]
    public async Task UpdateAddressFromOncologyVoucherTriageAsync_ShouldThrowException_WhenApiResponseIsNull()
    {
        // Arrange
        var address = new AddressServiceWrapper.Address
        {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<GeneralApiException>(() => 
            _helper.UpdateAddressFromOncologyVoucherTriageAsync(address, oncologyVoucherTriage, cancellationToken));
    }

    [Fact]
    public async Task CreateCaseFromOncologyVoucherTriageAsync_ShouldCreateCaseSuccessfully()
    {
        // Arrange
        var addressId = 1;
        var oncologyVoucherTriage = new OncologyVoucherTriage
        ...
        // Act
        var result = await _helper.CreateCaseFromOncologyVoucherTriageAsync(addressId, oncologyVoucherTriage, cancellationToken);
    ...
    [InlineData(CaseServiceWrapper.ValidState.Error)]
    [InlineData(CaseServiceWrapper.ValidState.Unknown)]
    public async Task CreateCaseFromOncologyVoucherTriageAsync_ShouldThrowException_WhenApiResponseIsInvalid(CaseServiceWrapper.ValidState validState)
    {
        // Arrange
        var addressId = 1;
        var oncologyVoucherTriage = new OncologyVoucherTriage();
        ...
        // Act & Assert
        await Assert.ThrowsAsync<GeneralApiException>(() => _helper.CreateCaseFromOncologyVoucherTriageAsync(addressId, oncologyVoucherTriage, cancellationToken));
    }

    [Fact]
    public async Task UpdateCaseFromOncologyVoucherTriageAsync_ShouldUpdateCaseSuccessfully()
    {
        // Arrange
        var caseId = 123;
        var oncologyVoucherTriage = new OncologyVoucherTriage { };
        ...
        // Act
        await _helper.UpdateCaseFromOncologyVoucherTriageAsync(caseId, oncologyVoucherTriage, cancellationToken);
    ...
    [InlineData(CaseServiceWrapper.ValidState.Error)]
    [InlineData(CaseServiceWrapper.ValidState.Unknown)]
    public async Task UpdateCaseFromOncologyVoucherTriageAsync_ShouldThrowException_WhenApiReturnsInvalidResponse(
        CaseServiceWrapper.ValidState validState)
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<GeneralApiException>(() => _helper.UpdateCaseFromOncologyVoucherTriageAsync(caseId, oncologyVoucherTriage, cancellationToken));
    }
}
