...
:loop
    ...
    %BATCH_ROOT%\PharmacyBusiness\bin\Wegmans.InterfaceEngine.exe -a RX.PharmacyBusiness.ETL.dll -i HistoricalDownloadForSTC -RunDate %runDate% -StartDate %START_DATE%
    IF %ERRORLEVEL% NEQ 0 (
