...
FROM (
		SELECT UNIQUE 
			...
			WEGMANS.Clean_String_ForTenUp(addr.PADR_ADDRESS1) address_one,
			WEGMANS.Clean_String_ForTenUp(addr.PADR_ADDRESS2) address_two,
			WEGMANS.Clean_String_ForTenUp(addr.PADR_CITY) addr_city,
			WEGMANS.Clean_String_ForTenUp(addr.PADR_EMAIL_ADDRESS) email,
			WEGMANS.Clean_String_ForTenUp(addr.PADR_WEB_ADDRESS) web_addr,
			addr.PADR_STATE_CODE state,
			addr.PADR_ZIPCODE zipcode,
			WEGMANS.Clean_String_ForTenUp(addr.PADR_EXT) zip_ext,
			WEGMANS.Clean_String_ForTenUp(addr.PADR_COUNTY) county,
			...
			WEGMANS.Clean_String_ForTenUp(addr.PADR_PRACTICE_NAME) practice_name,
			...
			WEGMANS.Clean_String_ForTenUp(primph.AREA_CODE) area_code_prim,
			WEGMANS.Clean_String_ForTenUp(primph.PHONE_NUM) phone_num_prim,
			WEGMANS.Clean_String_ForTenUp(primph.EXT) ext_prim,
    
			WEGMANS.Clean_String_ForTenUp(secnph.AREA_CODE) area_code_sec,
			WEGMANS.Clean_String_ForTenUp(secnph.PHONE_NUM) phone_num_sec,
			WEGMANS.Clean_String_ForTenUp(secnph.EXT) ext_sec,
    
			WEGMANS.Clean_String_ForTenUp(faxph.AREA_CODE) area_code_fax,
			WEGMANS.Clean_String_ForTenUp(faxph.PHONE_NUM) phone_num_fax,
			WEGMANS.Clean_String_ForTenUp(faxph.EXT) ext_fax,
    
			WEGMANS.Clean_String_ForTenUp(otherph.AREA_CODE) area_code_other,
			WEGMANS.Clean_String_ForTenUp(otherph.PHONE_NUM) phone_num_other,
			WEGMANS.Clean_String_ForTenUp(otherph.EXT) ext_other,
    
			WEGMANS.Clean_String_ForTenUp(elseph.PHONE_TYPE) phone_type_other2,
			WEGMANS.Clean_String_ForTenUp(elseph.AREA_CODE) area_code_other2,
			WEGMANS.Clean_String_ForTenUp(elseph.PHONE_NUM) phone_num_other2,
			WEGMANS.Clean_String_ForTenUp(elseph.EXT) ext_other2,      
...
WHERE last_update = To_Number(To_Char((:RunDate - 1),'YYYYMMDD')) OR padr_key = 12495740