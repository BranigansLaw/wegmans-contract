...
:loop
    ...
    %BATCH_ROOT%\PharmacyBusiness\bin\Wegmans.InterfaceEngine.exe -a RX.PharmacyBusiness.ETL.dll -i DownloadWorkloadBalance -TargetRecipients LOGILE -RunDate %runDate%
    IF %ERRORLEVEL% NEQ 0 (
