namespace RX.PharmacyBusiness.ETL.CRX572
{
    ...
    [JobNotes("CRX572", "Download Super Claim Feed.", "KBA00024913", "https://smartit.wegmans.com/smartit/app/#/knowledge/AGHAA5V0G0UJZAOKTYP3NCLGUHPXFZ")]
    public class DownloadsForIMS : ETLBase
    {
        protected override void Execute(out object result)
        {
            ...
            download.DownloadQueryByRunDateToFile(
                150,
                @"%BATCH_ROOT%\CRX572\bin\WEG_086_YYYYMMDD_01.sql",
                @"%BATCH_ROOT%\CRX572\Output\WEG_086_" + runDate.ToString("yyyyMMdd") + "_01.txt",
                runDate,
                false,
                string.Empty,
                string.Empty,
            ...
            fileHelper.CopyFileToArchiveForQA(@"%BATCH_ROOT%\CRX572\Output\WEG_086_" + runDate.ToString("yyyyMMdd") + "_01.txt");
