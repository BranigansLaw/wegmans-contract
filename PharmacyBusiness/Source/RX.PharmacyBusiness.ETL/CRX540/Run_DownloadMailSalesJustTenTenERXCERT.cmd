...
:loop
    ...
    %BATCH_ROOT%\PharmacyBusiness\bin\Wegmans.InterfaceEngine.exe -a RX.PharmacyBusiness.ETL.dll -i DownloadMailSales -TargetRecipients TENTEN_ERXCERT -RunDate %runDate%
    IF %ERRORLEVEL% NEQ 0 (
