namespace RX.PharmacyBusiness.ETL.CRX540.Business.Rules
{
    ...
    public class IsItemShippingChargeRule : IRule<PrescriptionSale>
    {
        ...
        private bool HasNonZeroShipHandleFee(PrescriptionSale entity)
        {
            return DerivePrescriptionSaleData.DeriveShipHandleFee(entity) != 0;
        }
    }
}
