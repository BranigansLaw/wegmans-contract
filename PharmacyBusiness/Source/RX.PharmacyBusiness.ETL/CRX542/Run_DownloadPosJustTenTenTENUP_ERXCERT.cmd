...
:loop
    ...
    %BATCH_ROOT%\PharmacyBusiness\bin\Wegmans.InterfaceEngine.exe -a RX.PharmacyBusiness.ETL.dll -i DownloadPos -TargetRecipients TENTEN_TENUP_ERXCERT -RunDate %runDate%
    IF %ERRORLEVEL% NEQ 0 (
