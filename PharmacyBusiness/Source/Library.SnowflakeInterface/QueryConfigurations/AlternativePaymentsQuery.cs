...
{
    public class AlternativePaymentsQuery : AbstractQueryConfiguration<AlternativePaymentsRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/Alternative_Payments_YYYYMMDD.sql";
        ...
        /// <inheritdoc />
        public override AlternativePaymentsRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating AlternativePayments");
