...
{
    public class McKessonImmunizationsQuery : AbstractQueryConfiguration<McKessonImmunizationsRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/McKessonImmunizations.sql";
        ...
        /// <inheritdoc />
        public override McKessonImmunizationsRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating McKessonOracleDW");
