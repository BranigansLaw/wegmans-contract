...
{
    public class SelectThirdPartyClaimsBaseQuery : AbstractQueryConfiguration<SelectThirdPartyClaimsBaseRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/SelectThirdPartyClaimsBase.sql";
        ...
        /// <inheritdoc />
        public override SelectThirdPartyClaimsBaseRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating SelectThirdPartyClaimsBase");
