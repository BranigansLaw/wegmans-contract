...
{
    public class ETLCheckOracleDWQuery : AbstractQueryConfiguration<ETLCheckDWRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/ETLCheck_Oracle_DW.sql";
        ...
        /// <inheritdoc />
        public override ETLCheckDWRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating ETLCheckOracleDW");
