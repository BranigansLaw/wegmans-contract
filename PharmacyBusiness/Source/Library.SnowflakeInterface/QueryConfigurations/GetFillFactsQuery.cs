...
{
    public class GetFillFactsQuery : AbstractQueryConfiguration<GetFillFactsRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/GetFillFacts.sql";
        ...
        /// <inheritdoc />
        public override GetFillFactsRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating GetFillFacts");
