...
{
    public class AtebMasterQuery : AbstractQueryConfiguration<AtebMasterRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/AtebMaster_YYYYMMDD.sql";
        ...
        /// <inheritdoc />
        public override AtebMasterRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating AtebMaster");
