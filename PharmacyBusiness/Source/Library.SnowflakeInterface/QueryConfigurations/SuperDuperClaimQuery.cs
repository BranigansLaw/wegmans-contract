...
{
    public class SuperDuperClaimQuery : AbstractQueryConfiguration<SuperDuperClaimRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/Super_Duper_Claim_YYYYMMDD.sql";
        ...
        /// <inheritdoc />
        public override SuperDuperClaimRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating SuperDuperClaim");
