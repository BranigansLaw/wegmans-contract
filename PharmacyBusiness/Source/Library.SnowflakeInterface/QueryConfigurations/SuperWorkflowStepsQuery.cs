...
{
    public class SuperWorkflowStepsQuery : AbstractQueryConfiguration<SuperWorkflowStepsRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/Super_Workflow_Steps_YYYYMMDD.sql";
        ...
        /// <inheritdoc />
        public override SuperWorkflowStepsRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating SuperWorkflowSteps");
