...
{
    public class TagPatientGroupsQuery : AbstractQueryConfiguration<TagPatientGroupsRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/TagPatientGroups_YYYYMMDD.sql";
        ...
        /// <inheritdoc />
        public override TagPatientGroupsRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating TagPatientGroups");
