...
{
    public class MightBeSoldTransactionsQuery : AbstractQueryConfiguration<MightBeSoldTransactionsRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/MightBeSoldTransactions.sql";
        ...
        /// <inheritdoc />
        public override MightBeSoldTransactionsRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating MightBeSoldTransactions");
