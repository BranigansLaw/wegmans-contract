...
{
    public class GetIVROutboundCallsQuery : AbstractQueryConfiguration<GetIVROutboundCallsRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/Get_IVR_Outbound_Calls.sql";
        ...
        /// <inheritdoc />
        public override GetIVROutboundCallsRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating GetIVROutboundCalls");
