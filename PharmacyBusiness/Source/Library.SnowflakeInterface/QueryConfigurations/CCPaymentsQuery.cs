...
{
    public class CCPaymentsQuery : AbstractQueryConfiguration<CCPaymentsRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/CC_Payments_YYYYMMDD.sql";
        ...
        /// <inheritdoc />
        public override CCPaymentsRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating CCPayments");
