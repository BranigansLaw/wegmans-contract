...
{
    public class SelectRxErpQuery : AbstractQueryConfiguration<SelectRxErpRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/SelectRxErp.sql";
        ...
        /// <inheritdoc />
        public override SelectRxErpRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating SelectRxErp");
