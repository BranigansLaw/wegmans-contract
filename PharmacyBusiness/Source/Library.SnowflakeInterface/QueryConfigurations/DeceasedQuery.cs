...
{
    public class DeceasedQuery : AbstractQueryConfiguration<DeceasedRow>
    {
        public required DateOnly RunDate { get; set; }

        /// <inheritdoc />
        public override string QueryFilePath => "./SnowflakeSQL/Deceased_YYYYMMDD.sql";
        ...
        /// <inheritdoc />
        public override DeceasedRow MapFromDataReaderToType(DbDataReader reader, Action<string> logDebug)
        {
            logDebug("Creating DeceasedRow");
            return new DeceasedRow
            {
                PdPatientNumber = reader.GetValueByIndex<long>(0),
            };
        }
    }
}
