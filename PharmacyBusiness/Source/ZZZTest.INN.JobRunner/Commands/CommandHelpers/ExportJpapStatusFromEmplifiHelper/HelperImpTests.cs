...
namespace ZZZTest.INN.JobRunner.Commands.CommandHelpers.ExportJpapStatusFromEmplifiHelper;

public class HelperImpTests
{
    private readonly HelperImp _sut;
    private readonly IEmplifiFieldConverter _emplifiFieldConverterImp;
    private readonly IEmplifiMapper _emplifiMapperImp;
    private EmplifiTestCases _emplifiTestCases;
    private readonly JpapDispenseAndStatusHelperImp _jpapDispenseAndStatusHelperImp;

    public HelperImpTests()
    {
        _emplifiTestCases = new EmplifiTestCases();
        _emplifiFieldConverterImp = new EmplifiFieldConverterImp();
        _emplifiMapperImp = new EmplifiMapperImp(_emplifiFieldConverterImp);
        _jpapDispenseAndStatusHelperImp = new JpapDispenseAndStatusHelperImp();
    ...
    public void SelectDataRowsMatchingBusinessRules_ShouldSkipDuplicates(string runForDateTime, int expectedSuccessfulRecordCount, int expectedFailureRecordCount)
    {
        ...
        var dateRange = _jpapDispenseAndStatusHelperImp.GetDateRangeForOutboundStatus(runFor);
        IEnumerable<Case> cases = _emplifiTestCases.Cases20250113143000;
    ...
    {
        // Setup
        string expectedReportingStatusDescription = EmplifiFieldConverterImp.ErrorAssigningValueMessage;
        DateTime runFor = DateTime.Parse(runForDateTime);
        var dateRange = _jpapDispenseAndStatusHelperImp.GetDateRangeForOutboundStatus(runFor);
        IEnumerable<Case> cases = _emplifiTestCases.Cases20250113143000;
           ...
           int expectedErrorAssigningValueCount)
    {
        ...
        DateTime runFor = DateTime.Parse(runForDateTime);
        var dateRange = _jpapDispenseAndStatusHelperImp.GetDateRangeForOutboundStatus(runFor);
        IEnumerable<Case> cases = _emplifiTestCases.Cases20250114143000;
    ...
    public void FormatTransactionID_ShouldReturnFormatedValueWithValidInputDataAsExpected(string addressId, string caseId, string issueSeq, string expectedResult)
    {
        ...
        // Act
        var actualResult = _emplifiFieldConverterImp.FormatTransactionID(testCase.AddressList.Address[0].address_id, testCase.case_id, testCase.IssueList.Issue[0].issue_seq, new List<string>());
    ...
    public void FormatYYYYMMDDDob_ShouldReturnDefaultOrInvalidInputDataAsExpected(string date)
    {
        ...
        // Act
        var actualResult = _emplifiFieldConverterImp.FormatDateToYYYYMMDDDob(testCase.AddressList.Address[0].a05_code, new List<string>());
    ...
    public void FormatYYYYMMDDHHMMSS_ShouldReturnWithValidDataAsExpected(string date, long expectedResult)
    {
        ...
        // Act
        var actualResult = _emplifiFieldConverterImp.FormatDateToYYYYMMDDHHMMSS(testCase.IssueList.Issue[0].c26_code, new List<string>());
    ...
    public void GetCarrier_ShouldReturnWithValidDataAsExpected(string status, string carrier, string expectedResult)
    {
        ...
        // Act
        var actualResult = _emplifiFieldConverterImp.GetCarrier(testCase.IssueList.Issue[0].c16_code, testCase.IssueList.Issue[0].c84_code, new List<string>());
    ...
    public void GetQuantity_ShouldReturnWithValidDataAsExpected(string status, string quantity, int? expectedResult)
    {
        ...
        // Act
        var actualResult = _emplifiFieldConverterImp.GetQuantity(testCase.IssueList.Issue[0].c16_code, testCase.IssueList.Issue[0].c07_code, new List<string>());
    ...
    public void GetXPres_ShouldReturnWithValidDataAsExpected(string? pres, string healthCare, string expectedResult)
    {
        ...
        // Act
        var actualResult = _emplifiFieldConverterImp.GetPresAddr1(testCase.AddressList.Address[0].a44_code, testCase.AddressList.Address[0].a24_code, new List<string>());
    ...
    public void GetStatus_ShouldReturnWithValidDataAsExpected(string status, string expectedResult)
    {
        ...
        // Act
        var actualResult = _emplifiFieldConverterImp.GetStatus(testCase.IssueList.Issue[0].c16_code, new List<string>());
